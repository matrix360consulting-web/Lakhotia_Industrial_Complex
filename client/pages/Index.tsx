...
import HeroBanner from "./GateUnit.jpeg";
...
export default function Index() {
  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <section
        id="home"
        className="w-full min-h-screen mt-2 relative overflow-hidden bg-[#f5efe2]"
      >
        <div className="hidden md:block absolute inset-0">
<img
  src={HeroBanner}
  alt="Lakhotia Industrial Complex"
  className="absolute top-0 right-0 w-[85%] h-full object-cover"
  style={{
    width: "115%",
    left: "20%",
}}
/>
 ...
 <div
  ...
  style={{
    background:
      "linear-gradient(90deg, #f5efe2 0%, #f5efe2 40%, rgba(245, 239, 226, 0.77) 42%,rgba(245, 239, 226, 0.26) 55%, rgba(245, 239, 226, 0.12) 70%, rgba(245,239,226,0) 85%)",
  }}
></div>
</div>
        {/* Content */}

        <div className="relative z-10 pt-16 h-full flex items-center justify-start px-8 sm:px-10 md:px-14 lg:px-20">
          ...
          <div className="mb-16">
            <div className="-mb-4">
              <img
                src={Made}
                alt="Make In India"
                className="w-56 md:w-60 object-contain -mb-20 -ml-8 opacity-90"
              />
            </div>
            ...
            {[
              {
                ...
                desc: "Plots from 1 Acre to 6+ Acres, customised to match exactly what your operation needs.",
                tag: "1–6+ Acres",
              },
              {
                num: null,
      ...
      <section className="bg-amber-50 border-t border-amber-900/20 py-12">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 md:px-12">
          <div className="mb-16 max-w-2xl">
            ...
            <div className="h-1 w-9 bg-orange-500 mb-6"></div>
            <p className="text-base leading-relaxed text-slate-700">
              From a 1-acre SME factory to a 6+ acre custom campus — we work
