...
const websiteAnswers: Record<string, string> = {
  ...
  contact:
    "You can call or WhatsApp on +91 7450008999.",
...
useEffect(() => {
  ...
  const handleSubmit = async (type: "consultation" | "site_visit") => {
...
if (
  ...
  alert("Please select a visit date and preferred time.");
  return;
}
  ...
  ...formData,
  visit_date:
    type === "consultation" ? null : formData.visit_date,
  visit_time:
    type === "consultation" ? null : formData.visit_time,
...
/>
                      <button
  onClick={() => handleSubmit("site_visit")}
  disabled={!formData.name || !formData.mobile}
            ...
            <div className="lg:col-span-1">
              <div className="space-y-0.5 bg-slate-900/10 p-0.5">
                ...
                <div className="bg-white p-6 text-xs text-slate-600 leading-relaxed">
                  ...
                  <p>Established: 2025 · Development Commences</p>
